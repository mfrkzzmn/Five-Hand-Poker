...
describe Hand do
  ...
  describe "#four_of_a_kind" do
    it "check if four of a kind exists if there is a double pair" do
      hand = Hand.new(@cards)
      hand1 = []
      suits = ["spade", "hearts", "club", "diamond"]
      values = ['A', 'A', '9', '9', '10']
      ...
      expect(hand.check_four_of_a_kind(hand1)).to eql(0)
    end

    it "check if four of a kind exists if there is all different card values" do
      hand = Hand.new(@cards)
      hand1 = []
      suits = ["spade", "hearts", "club", "diamond"]
      values = ['A', '2', '9', '6', '10']
    ...
    it "check if four of a kind exists if there is a single pair" do
      hand = Hand.new(@cards)
      hand1 = []
      suits = ["spade", "hearts", "club", "diamond"]
      values = ['A', '2', 'K', '2', '10']
    ...
    it "check if four of a kind exists if there is a three of a kind" do
      hand = Hand.new(@cards)
      hand1 = []
      suits = ["spade", "hearts", "club", "diamond"]
      values = ['A', '2', '6', '6', '6']
    ...
    it "check if four of a kind exists if there is a four of a kind" do
      hand = Hand.new(@cards)
      hand1 = []
      suits = ["spade", "hearts", "club", "diamond"]
      values = ['6', 'A', '6', '6', '6']
  ...
  describe "#check_straight" do
    it "check if a hand is straight if five cards of any suit squence occurs" do
      hand = Hand.new(@cards)
      hand1 = []
      suits = ["spade", "hearts", "club", "diamond"]
      values = ['A', 'K', 'Q', 'J', '10']
  ...
  describe "#check_straight_flush " do
    it "check if a hand is straight flush if five cards of any suit squence occurs" do
      hand = Hand.new(@cards)
      hand1 = []
      suits = ["spade", "hearts", "club", "diamond"]
      values = ['A', 'K', 'Q', 'J', '10']
  ...
  describe "#check_foyal_flush " do
    it "check if a hand is royal flush if five cards of any suit squence occurs" do
      hand = Hand.new(@cards)
      hand1 = []
      suits = ["spade", "hearts", "club", "diamond"]
      values = ['A', 'K', 'Q', 'J', '10']
      ...
      expect(hand.check_royal_flush(hand1)).to eql(0)
    end

    it "check if a hand is royal flush if five cards of any suit squence occurs with an Ace and lower valued cards" do
      hand = Hand.new(@cards)
      hand1 = []
      suits = ["spade", "hearts", "club", "diamond"]
      values = ['4', '3', '5', '2', 'A']
    ...
    it "check if a hand is royal flush if there is straight flush" do
      hand = Hand.new(@cards)
      hand1 = []
      suits = ["spade", "spade", "spade", "spade"]
      values = ['9', 'K', 'Q', 'J', '10']
    ...
    it "check if a hand is royal flush if there is straight flush with Ace and lower valued cards" do
      hand = Hand.new(@cards)
      hand1 = []
      suits = ["spade", "spade", "spade", "spade"]
      values = ['3', '2', '4', 'A', '5']
    ...
    it "check if a hand is royal flush if there is royal flash" do
      hand = Hand.new(@cards)
      hand1 = []
      suits = ["spade", "spade", "spade", "spade"]
      values = ['A', 'K', 'Q', 'J', '10']
      ...
      expect(hand.check_royal_flush(hand1)).to eql(1)
    end
  end

  describe "#check_flush " do
    it "check if a hand is flush if five cards of any suit squence occurs" do
      hand = Hand.new(@cards)
      hand1 = []
      suits = ["spade", "hearts", "club", "diamond"]
      values = ['A', 'K', 'Q', 'J', '10']
      ...
      expect(hand.check_flush(hand1)).to eql(0)
    end

    it "check if a hand is flush if five cards of any suit squence occurs with an Ace and lower valued cards" do
      hand = Hand.new(@cards)
      hand1 = []
      suits = ["spade", "hearts", "club", "diamond"]
      values = ['4', '3', '5', '2', 'A']
    ...
    it "check if a hand is flush if there is straight flush" do
      hand = Hand.new(@cards)
      hand1 = []
      suits = ["spade", "spade", "spade", "spade"]
      values = ['9', 'K', 'Q', 'J', '10']
    ...
    it "check if a hand is flush if there is straight flush with Ace and lower valued cards" do
      hand = Hand.new(@cards)
      hand1 = []
      suits = ["spade", "spade", "spade", "spade"]
      values = ['3', '2', '4', 'A', '5']
    ...
    it "check if a hand is flush if there is royal flash" do
      hand = Hand.new(@cards)
      hand1 = []
      suits = ["spade", "spade", "spade", "spade"]
      values = ['A', 'K', 'Q', 'J', '10']
    ...
    it "check if a hand is flush if there is flash" do
      hand = Hand.new(@cards)
      hand1 = []
      suits = ["spade", "spade", "spade", "spade"]
      values = ['A', '3', '8', 'J', '5']
